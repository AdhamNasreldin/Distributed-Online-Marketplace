...
CREATE TABLE IF NOT EXISTS `ProductListing` (
    ...
    -- Note: Foreign key to Seller is omitted here because Seller is horizontally sharded 
    -- and cross-database/cross-shard foreign keys are not supported natively.
);
